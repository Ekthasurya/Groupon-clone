    ...
    <Box padding={5}>
      <Flex direction="column" gap={2} >
        ...
        <Flex wrap="wrap" justify="space-between" gap={5}>
          {/* Category Boxes */}
          <Flex w={{ base: '100%', sm: '48%', md: '150px' }}>
            <Box border="1px solid #eeeff1" w="100%" p={2} h={70} borderRadius={10}>
          ...
          <Flex w={{ base: '100%', sm: '48%', md: '150px' }}>
            <Box border="1px solid #eeeff1" w="100%" p={2} h={90} borderRadius={10}>
              <Flex textAlign="center" justifyContent="center">
        ...
        <Flex direction="column" marginTop={5}>
          ...
          <Flex wrap="wrap" justify="space-between" gap={5}>
            <Flex w={{ base: '100%', sm: '48%', md: '280px' }}>
              <Flex border="1px solid #eeeff1" w="100%" p={1} borderRadius={10} justify="space-between" align="center">
            ...
            <Flex w={{ base: '100%', sm: '48%', md: '330px' }}>
              <Flex border="1px solid #eeeff1" w="100%" p={1} borderRadius={10} justify="space-between" align="center">
            ...
            <Flex w={{ base: '100%', sm: '48%', md: '320px' }}>
              <Flex border="1px solid #eeeff1" w="100%" p={1} borderRadius={10} justify="space-between" align="center">
