...
function ReadMoreExample() {
  ...
  // Responsive padding for the button based on screen size
  const buttonPadding = useBreakpointValue({ base: "0", md: "200px" });
  ...
  return (
    <VStack spacing={4} align="start" width="full" maxWidth="1200px" margin="0 auto" padding="20px">
      ...
      <Button
        ...
        colorScheme="teal"
        paddingLeft={buttonPadding} // Responsive padding
      >
