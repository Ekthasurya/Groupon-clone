...
const Footer = () => {
  return (
    <Box backgroundColor="#eeeff1">
      <Flex
        direction={{ base: "column", md: "row" }} // Stacks elements in a column on small screens and row on larger ones
      ...
      >
        <Flex direction="column" gap={2} w={{ base: "100%", md: "30%" }}>
          ...
          <Select placeholder='USA' borderRadius={20} w="100%">
            <option>USA</option>
        ...
        <Flex direction="column" gap={2} w={{ base: "100%", md: "30%" }}>
          ...
          <Flex gap={2}>
            <Input placeholder='Email' size='md' w="100%" />
        ...
        <Flex direction="column" w={{ base: "100%", md: "30%" }}>
          ...
          <Flex gap={1} direction={{ base: "column", md: "row" }} align="center">
            <Image
              boxSize='100px'
              objectFit='cover'
      ...
      <Flex
        direction={{ base: "column", md: "row" }} // Stacks elements on small screens and arranges them in a row on larger screens
        justifyContent="space-between"
        p={7}
        gap={5}
      >
        <Flex direction='column' gap={3} w={{ base: "100%", md: "25%" }}>
